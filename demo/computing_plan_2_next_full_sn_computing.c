				...
				for ( j = 0; j < columns; j+=pack_j )
					{
                        ...
                        // if ( column_number_sn != 8 && column_number_sn != 1 )
                        // 	printf("sn_number = %d thresold = %d\n", column_number_sn, thresold);
